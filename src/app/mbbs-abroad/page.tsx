...
const mbbsData = {
  ...
  destinations: [
    { 
      country: "Kazakhstan", 
      image: "https://royaleducationworld.com/wp-content/uploads/2025/05/1-University-Main-Building-1-scaled.jpg", 
      universities: ["West Marat Ospanov Medical University", "Semey State Medical University", "IMS Almaty"] 
    },
    { 
