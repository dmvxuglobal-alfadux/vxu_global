      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
          <motion.div
            ...
            className="bg-white rounded-[2rem] shadow-2xl overflow-hidden max-w-[360px] w-full relative border border-slate-100"
          >
            <button
              onClick={onClose}
              className="absolute top-4 right-4 text-slate-400 hover:text-primary transition-colors z-10 p-1.5 hover:bg-slate-100 rounded-full"
            >
              <X size={16} />
            </button>
